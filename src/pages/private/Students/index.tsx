        ...
        <div className="flex flex-col md:h-10 gap-y-3 md:items-center md:flex-row">
          ...
          <div className="flex flex-col sm:flex-row gap-x-3 gap-y-2 md:ml-auto">
            <Button
              ...
              // className="px-4 py-3 group-[.mode--light]:!bg-white/[0.12] group-[.mode--light]:!text-slate-200 group-[.mode--light]:!border-transparent"
            >
              <Lucide icon="PlusCircle" className="w-6 h-6 mr-2" />{" "}
        ...
        <div className="flex flex-col gap-8 mt-3.5">
          ...
          <div className="grid grid-cols-4 gap-5">
              ...
              <div className="col-span-4 md:col-span-2 xl:col-span-1 p-5 border border-dashed rounded-[0.6rem] border-slate-300/80 box shadow-sm">
                ...
                <div className="mt-1.5 text-2xl font-medium">32</div>
                <div className="absolute inset-y-0 right-0 flex flex-col justify-center mr-5">
                <div className="flex items-center border border-success/10 bg-success/10 rounded-full text-success">
                    <Lucide
                      icon="User"
              ...
              <div className="col-span-4 md:col-span-2 xl:col-span-1 p-5 border border-dashed rounded-[0.6rem] border-slate-300/80 box shadow-sm">
                ...
                <div className="mt-1.5 text-2xl font-medium">23 <span className="text-sm text-slate-400">alumnos</span></div>
                <div className="absolute inset-y-0 right-0 flex flex-col justify-center mr-5">
                <div className="flex items-center border border-success/10 bg-success/10 rounded-full text-success">
                    <Lucide
                      icon="User"
