...
`;
export const createPrivateEnrollment = /* GraphQL */ `
  mutation CreatePrivateEnrollment(
    $input: CreatePrivateEnrollmentInput!
    $condition: ModelPrivateEnrollmentConditionInput
  ) {
    createPrivateEnrollment(input: $input, condition: $condition) {
      id
      amountPaid
      startDate
      endDate
...
`;
export const updatePrivateEnrollment = /* GraphQL */ `
  mutation UpdatePrivateEnrollment(
    $input: UpdatePrivateEnrollmentInput!
    $condition: ModelPrivateEnrollmentConditionInput
  ) {
    updatePrivateEnrollment(input: $input, condition: $condition) {
      id
      amountPaid
      startDate
      endDate
...
`;
export const deletePrivateEnrollment = /* GraphQL */ `
  mutation DeletePrivateEnrollment(
    $input: DeletePrivateEnrollmentInput!
    $condition: ModelPrivateEnrollmentConditionInput
  ) {
    deletePrivateEnrollment(input: $input, condition: $condition) {
      id
      amountPaid
      startDate
      endDate
...
`;
export const createWorkdayReports = /* GraphQL */ `
  mutation CreateWorkdayReports(
    $input: CreateWorkdayReportsInput!
    $condition: ModelWorkdayReportsConditionInput
  ) {
    createWorkdayReports(input: $input, condition: $condition) {
      workdayId
      date
      day
      month
...
`;
export const updateWorkdayReports = /* GraphQL */ `
  mutation UpdateWorkdayReports(
    $input: UpdateWorkdayReportsInput!
    $condition: ModelWorkdayReportsConditionInput
  ) {
    updateWorkdayReports(input: $input, condition: $condition) {
      workdayId
      date
      day
      month
...
`;
export const deleteWorkdayReports = /* GraphQL */ `
  mutation DeleteWorkdayReports(
    $input: DeleteWorkdayReportsInput!
    $condition: ModelWorkdayReportsConditionInput
  ) {
    deleteWorkdayReports(input: $input, condition: $condition) {
      workdayId
      date
      day
      month
